...
class ValidadorRegistro{
	...
	private function validar_nombre($conexion,$nombre){
		...
		if(strlen($nombre) > 24){
			return "El nombre debe ser más corto de 24 caracteres";
		}
		
		if(RepositorioUsuario::nombre_existe($conexion,$nombre)){
			return "Este nombre de usuario está en uso, porfavor prueba otro nombre";
		}
	...
	private function validar_email($conexion,$email){
		...
		if(RepositorioUsuario::email_existe($conexion,$email)){
			return 'Este email está en uso, porfavor prueba otro email o <a href="#">intente recuperar su contraseña</a>.';
		}
